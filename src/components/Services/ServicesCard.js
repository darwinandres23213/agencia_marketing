function ServicesCard({data,index}){
    ...
    return(
        ...
        className="w-full mx-auto lg:mx-12 relative p-6 h-96 lg:h-[200pm] bg-white  hover:translate-y-1 transition duration-300 ease-in-out">
            ...
            <div className="absolute bottom-0 left-0 p-8" >
                <h2  id={index} className="items-end text-xl font-semibold text-gray-900 pt-8 ">L More</h2>
            </div>
        </div>
    )
}
