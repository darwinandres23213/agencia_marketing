...
function PositionList(){
    return(
        <div className="mx-auto lg:mx-12 max-w-full  bg-white">
            <h2 className="text-5xl font-semibold text-gray-900 pb-8">Open Positions</h2>
            <p className="text-2xl font-regular text-gray-900 max-w-5xl leading-10" >Ac euismod vel sit maecenas id pellentesque eu sed consectetur. Malesuada adipiscing sagittis vel nulla nec.</p>
            ...
            <div className="overflow-hidden bg-white shadow sm:rounded-md py-8">
