...
function Navbar(){
    ...
    return(
        <nav data-scroll data-scroll-id="hey" id='navbar' className='w-full mx-auto lg:mx-12 py-6 top-0 transition duration-300 ease-in-out z-40 fixed'>
            <div className="px-4 sm:px-6">
                <div className="-ml-4 mx-auto lg:mx-12 -mt-2 hidden lg:flex flex-wrap items-center justify-between sm:flex-nowrap md:px-14 px-2">
  ...
  function IconThree() {
    return (
      ...
      >
        ...
        <rect x="25" y="20" width="2" height="16" fill="#FDB A74" />
